...
public static class SaltnPepperLogic
{
    private static readonly double[][] _multipliers = new double[][]
    {
        ...
        new double[] {1.3,1.74,2.35,3.23,4.52,6.46,9.44,14.17,21.89,35.03,58.38,102.17,189.75,379.5,834.9,2087.25,6261.75,25047,175329},
    ...
    {
        if(gridPosition < 0) throw new ArgumentException("Picked position should be biggeer than 0!");
        if(gridPosition >= grid.Length) throw new ArgumentException("Picked position should be smaller than the grid size!");
