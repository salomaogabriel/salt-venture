...
public static class HangmanLogic
{
    ...
    // public static bool IsGameOver(string Word, char Letter)
    // {
    //     return 
    // }
    public static string PickLetter(string Word, char Letter)
    {
        var list = new List<char>(Letter);
        return new string(list.ToArray());
    }

    // public static double CalculateMultiplier(Hangman game)
    // {
    //     if(game.LetterPicks!.Length == 0 || game.LetterPicks == null) return 1;
    //     try
    //     {

    //         return _multipliers[game.LetterPicks.Length - 1][game.WordLength - 1];
    //     }
    //     catch(Exception e)
    //     {
    //         return 1;
